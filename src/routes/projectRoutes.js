...
router.put("/:id", authenticate, authorize(["ADMIN","SUPER_ADMIN", "MANAGER"]), updateProject);
router.delete("/:id", authenticate, authorize(["ADMIN","SUPER_ADMIN", "MANAGER"]), deleteProject);
